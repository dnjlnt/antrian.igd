<html lang='en'>
            ...
            <div class="card bg-light text-dark" style="padding:15px 10px 15px 10px;">
                <form id="form_ttv">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" id="tekanan_darah_sistolik" name="tekanan_darah_sistolik">
                    </div>
                    <div class="form-group">
                        <label class="form-check-label" for="tekanan_darah"><strong>Tekanan Darah Diastolik *</strong></label>
                        <input class="form-control" type="number" id="tekanan_darah_diastolik" name="tekanan_darah_diastolik">
                    </div>
                    <div class="form-group">
                        <label class="form-check-label" for="respirasi"><strong>Respirasi *</strong></label>
                        <input class="form-control" type="number" id="respirasi" name="respirasi">
                    </div>
                    <div class="form-group">
                        <label class="form-check-label" for="saturasi"><strong>Saturasi O2 *</strong></label>
                        <input class="form-control" type="number" id="saturasi" name="saturasi">
                    </div>
                    <div class="form-group">
                        <label class="form-check-label" for="nadi"><strong>Nadi *</strong></label>
                        <input class="form-control" type="number" id="nadi" name="nadi">
                    </div>
                    <div class="form-group">
                        <label class="form-check-label" for="suhu"><strong>Suhu *</strong></label>
                        <input class="form-control" type="text" id="suhu" name="suhu">
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $("#suhu").inputmask({"mask": "99.9"})
        });

        $(document).ready(function(){
            $("#form_ttv").submit(function(e){
                e.preventDefault(); 
                ...
                $.ajax({
                    url:'<?php echo base_url();?>dashboard/savettv',
                    type:"post",

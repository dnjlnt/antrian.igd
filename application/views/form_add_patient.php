	...
	<head>
			...
			<div class="wrapper">
                <div class="card bg-light text-dark" style="padding:15px 20px 10px 10px;">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" id="tanggal_lahir" name="tanggal_lahir" data-date-format="DD-YYYY-MM">
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                    <div class="form-group">
                        <button class="btn btn-block btn-primary" onclick="saveNewPatient()">Simpan</button>
                    </div>
			    </div>
			</div>
		</body>
        <script>
            ...
            function saveNewPatient() {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo base_url();?>dashboard/savenewpatient',
                    data: {nama_pasien:nama_pasien, no_hp:no_hp, tanggal_lahir:tanggal_lahir, gender:gender},
